$(document).ready(function () {
  ...
  $.ajax({
    type: "GET",
    url: "/api/dra/leads/?name=" + getName,
    dataType: "json",
        ...
        $.each(response.results, function (k, v) {
          ...
          $("[data-leads-list]").append(
            "<tr class='table-row'><td>" +
              ...
              step +
              " </td><td class='text-center'> <a href='#'class='dashboard-btn'>Remind</a> </td></tr>"
          );
        });
  ...
  $(".custom-select").on("change", function () {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dra/leads/?name=" + getName + "&days=" + this.value,
      dataType: "json",
      success: function (response) {
        $(".main-loader").hide();
        $("[data-leads-list]").empty();
  ...
  $(".custom_date").flatpickr({
    ...
    onChange: function(dates, instance) {
        if (dates.length == 2) {
            ...
            $.ajax({
              type: "GET",
              url: "/api/dra/leads/?name=" + getName + "&to_date=" + end+"&from_date="+ start,
              dataType: "json",
              success: function (response) {
                $(".main-loader").hide();
                $("[data-leads-list]").empty();
  ...
  $("#pagination-here").on("page", function (event, num) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dra/leads/?name=" + getName + "&page=" + num,
      dataType: "json",
      success: function (response) {
        $("[data-leads-list]").empty();
        $(".main-loader").hide();
