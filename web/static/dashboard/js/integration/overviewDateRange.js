$(document).ready(function () {
  ...
  function getTotalMandatesR(start, end) {
    ...
    $.ajax({
      type: "GET",
      url:"/api/dsa/overview/total-lead/?to_date=" +end +"&from_date=" +start,
      dataType: "json",
      headers: {
  ...
  function getTotalChartR(start, end) {
    ...
    $.ajax({
      type: "GET",
      url:
        "/api/dsa/overview/successful-rate/?to_date=" +
        end +
        "&from_date=" +
        start,
      dataType: "json",
  ...
  function getbrokerageChartR(start, end) {
    ...
    $.ajax({
      type: "GET",
      url:
        "/api/dsa/overview/successful-disbursed/?to_date=" + end + "&from_date=" + start,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  function getLeadChartR(start, end) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/leads/?to_date=" + end + "&from_date=" + start,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  function topCardsR(start, end) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/?to_date=" + end + "&from_date=" + start,
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
      },
