$(document).ready(function () {
  ...
  function topCards(days) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/?days=" + days,
      headers: {
  ...
  function getLeadChart(days) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/leads/?days=" + days,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  function getbrokerageChart(days) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/successful-disbursed/?days=" + days,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  function getincentiveChart(days) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/incentive/?days=" + days,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  function gettotalChart(days) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/successful-rate/?days=" + days,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  //   $.ajax({
  //     type: "GET",
  //     url: "/api/dsa/overview/conversion/?days=" + days,
  //     dataType: "json",
  //     headers: {
  //       "Content-Type": "application/x-www-form-urlencoded",
  //       Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  //   $.ajax({
  //     type: "GET",
  //     url: "/api/dsa/overview/conversion-stage/?days=" + days,
  //     dataType: "json",
  //     headers: {
  //       "Content-Type": "application/x-www-form-urlencoded",
  //       Authorization: "Bearer " + localStorage.getItem("access-token"),
  ...
  function getTotalMandates(days) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/total-lead/?days=" + days,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
...
// referrals pie example
  function getdownloadChart(days) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/overview/app-downloads/?days=" + days,
      dataType: "json",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
        Authorization: "Bearer " + localStorage.getItem("access-token"),
