$(document).ready(function () {
  ...
  $.ajax({
    type: "GET",
    url: "/api/dsa/leads/?name=" + getName,
    dataType: "json",
        ...
        $.each(response.results, function (k, v) { 
          ...
          $("[data-leads-list]").append(
            "<tr class='table-row'><td>" +
              ...
              date_created +
              "</td><td class='text-center'> "+mandate_status+"</td><td class='text-center'> "+status+" </td><td class='text-center'> "+step+" </td><td class='text-center'> "+dra_name+" </td><td class='text-center'> <a href='#'class='dashboard-btn'>Remind</a> </td></tr>"
          );
        });
  ...
  $(".custom-select").on("change", function () {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/leads/?name=" + getName + "&days=" + this.value,
      dataType: "json",
      success: function (response) {
        $('[data-clear-filter]').show();
        $(".main-loader").hide();
  ...
  $(".custom_date").flatpickr({
    ...
    onChange: function(dates, instance) {
        if (dates.length == 2) {
            ...
            $.ajax({
              type: "GET",
              url: "/api/dsa/leads/?name=" + getName + "&to_date=" + end+"&from_date="+ start,
              dataType: "json",
              success: function (response) {  
                $('[data-clear-filter]').show();
                $(".main-loader").hide();
  ...
  $("#pagination-here").on("page", function (event, num) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/leads/?name=" + getName + "&page=" + num,
      dataType: "json",
      success: function (response) {
        $("[data-leads-list]").empty();
        $(".main-loader").hide();
