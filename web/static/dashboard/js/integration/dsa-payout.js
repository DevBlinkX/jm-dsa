$(document).ready(function () {
  ...
  $(".days-select").on("change", function () {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/payout-page/?days=" + this.value,
      dataType: "json",
      success: function (response) {
  ...
  $(".custom_date").flatpickr({
    ...
    onChange: function(dates, instance) {
        if (dates.length == 2) {
          ...
          $.ajax({
            type: "GET",
            url: "/api/dsa/payout-page/?to_date=" + end+"&from_date="+ start,
            dataType: "json",
            success: function (response) {
              $('[data-clear-filter]').show();
              $(".main-loader").hide();
  ...
  $("#pagination-here").on("page", function (event, num) {
    ...
    $.ajax({
      type: "GET",
      url: "/api/dsa/payout-page/?page=" + num,
      dataType: "json",
      success: function (response) {
        $(".main-loader").hide();
        $("[data-payout-list]").empty();
